<?php
// update_profile_cashier.php
// Saves the logged-in Cashier's own profile edits (staff_info table).
session_start();
require_once 'db_pharmacy.php';

header('Content-Type: application/json');

if (!isset($_SESSION['user_id']) || ($_SESSION['user_role'] ?? '') !== 'Cashier/Pharmacist') {
